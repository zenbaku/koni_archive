...
/// Corpus-driven fuzz smoke: bit-flip and truncation mutations over the
/// committed fixtures. Invariant: any input either parses or throws a typed
/// [ArchiveException], never a RangeError, never another error type, never a
/// hang, never unbounded memory.
void main() {
  test(
    ...
    () async {
      ...
      final fixtures =
          Directory('test/fixtures/xz')
              .listSync()
              .whereType<File>()
              .where((f) => f.path.endsWith('.xz'))
