...
/// Corpus-driven fuzz smoke over the committed `.bz2` fixtures: any input either
/// parses/decodes or throws a typed [ArchiveException] — never a RangeError,
/// never another error type, never a hang, never unbounded memory.
void main() {
  test(
    ...
    () async {
      ...
      final fixtures =
          Directory('test/fixtures/bzip2')
              .listSync()
              .whereType<File>()
              .where((f) => f.path.endsWith('.bz2'))
