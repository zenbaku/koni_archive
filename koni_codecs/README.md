...
cryptographic primitives the archive formats need to read password-protected
archives: AES-128/192/256 with CBC and CTR modes, SHA-1, SHA-256, HMAC, and
PBKDF2. Standards-defined, vector-tested, zero-dependency, and
dart2js/dart2wasm-exact. These exist to *read* encrypted archives — they are
not constant-time; don't build interactive security systems on them.
