...
Decisions made where the TAR format is ambiguous, matched against the reference
tools (bsdtar/GNU tar).
...
Represented, not decoded: old-GNU sparse extension blocks are skipped
...
entry never bricks the rest of the archive.
