...
/// archive. Application code uses the `Archive` facade in
...
///   exactly once, eagerly: O(entry count), no content decompression.
/// - [entries] is immutable, in archive index order, and includes duplicate
///   paths where the format allows them; paths are normalized.
...
///   encryption) throw here, never at open time; mid-decode failures
...
abstract class ArchiveReader {
  ...
  /// All entries, in archive index order. Unmodifiable.
