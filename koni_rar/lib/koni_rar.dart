...
/// variant H (`-mct` text compression, solid and non-solid, including a mid-file
/// PPMd→method-29 block switch), plus RAR 2.0/2.6 (unpack v20/v26) LZ. A filter
/// reached *through* a PPMd escape, a solid-PPMd mid-file switch, RAR 1.5 (v15),
/// and the RAR 2.x audio block stay typed errors.
