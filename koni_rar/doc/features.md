...
| Wrong password | `InvalidPasswordException` (reliable 8-byte check value) |
| RAR4 encrypted entries (`-p`) | `EncryptedArchiveException` — RAR4 crypto is P3-5, not yet wired |
