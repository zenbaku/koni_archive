...
`unrar` output. Provenance: see `doc/rar-provenance.md` (clean-room
...
start. Files/runs are capped at 1 GiB.
...
mtime is unix-seconds UTC. Unix-host attributes carry the st_mode
...
**Benchmark:** PPMd never appears in the manga corpus (RAR picks it for
